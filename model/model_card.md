...
one of seven traffic categories (benign, dos_ddos, port_scan, brute_force, web_attack, botnet, infiltration) and produces a
...
Latency: 1.469 ms/flow single,
0.0254 ms/flow batched (CPU).
